...
interface StockPerformanceLoadProgressDialogProps {
  isOpen: boolean
  onClose: () => void
...
const StockPerformanceLoadProgressDialog: React.FC<StockPerformanceLoadProgressDialogProps> = ({
  isOpen,
  onClose,
  onConfirm,
  onRetry,
  ...
  const getTitle = () => {
    switch (status) {
      case 'idle':
        return 'Load Stock Performance'
      case 'loading':
        return 'Generating Report...'
      case 'success':
        return 'Report Loaded Successfully!'
      case 'error':
  ...
  const getDescription = () => {
    switch (status) {
      case 'idle':
        return 'This will generate the stock performance report from the available data. This process may take a few moments.'
      case 'loading':
        return 'Please wait while we process and generate your stock performance report. Do not close this window.'
      case 'success':
        return 'The stock performance report has been successfully generated and is now up to date.'
      case 'error':
        return errorMessage || 'An error occurred while loading the report. Please try again.'
    }
  }
...
export default StockPerformanceLoadProgressDialog
